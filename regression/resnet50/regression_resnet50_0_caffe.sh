...
cvi_npz_tool.py extract $CAFFE_BLOBS_NPZ resnet50_in_fp32.npz input
cvi_npz_tool.py extract $CAFFE_BLOBS_NPZ resnet50_out_fp32_prob.npz prob

# fix input data consistency
# because jpeg decoder may introduce difference, use save file to overwrite
cvi_npz_tool.py compare resnet50_in_fp32.npz $REGRESSION_PATH/resnet50/data/resnet50_in_fp32.npz
