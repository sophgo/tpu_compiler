...
mlir-tpu-interpreter inception_v4.mlir \
    --tensor-in $DATA_PATH/test_cat_in_inception_v4_fp32.bin \
    --tensor-out out.bin \

bin_compare.py out.bin $DATA_PATH/test_cat_out_inception-v4_prob_fp32.bin \
...
mlir-opt \
    --convert-bn-to-scale \
    inception_v4.mlir \
    -o inception_v4_opt1.mlir

# test opt1
mlir-tpu-interpreter inception_v4_opt1.mlir \
    --tensor-in $DATA_PATH/test_cat_in_inception_v4_fp32.bin \
...
mlir-opt \
    --fold-scale \
    inception_v4_opt1.mlir \
    -o inception_v4_opt2.mlir

# test opt2
mlir-tpu-interpreter inception_v4_opt2.mlir \
    --tensor-in $DATA_PATH/test_cat_in_inception_v4_fp32.bin \
...
mlir-opt \
    ...
    -o inception_v4_opt3.mlir

# test opt3
mlir-tpu-interpreter inception_v4_opt3.mlir \
    --tensor-in $DATA_PATH/test_cat_in_inception_v4_fp32.bin \
...
mlir-opt \
    --fuse-relu \
    inception_v4_opt3.mlir \
    -o inception_v4_opt4.mlir

# test opt4
mlir-tpu-interpreter inception_v4_opt4.mlir \
    --tensor-in $DATA_PATH/test_cat_in_inception_v4_fp32.bin \
...
mlir-opt \
    --fuse-eltwise \
    inception_v4_opt4.mlir \
    -o inception_v4_opt5.mlir

# test opt5
mlir-tpu-interpreter inception_v4_opt5.mlir \
    --tpu-op-stats-filename inception_v4_op_stats.csv \
    --tensor-in $DATA_PATH/test_cat_in_inception_v4_fp32.bin \
