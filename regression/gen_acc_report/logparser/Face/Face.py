...
class LogParser():
    ...
    def load_data(self):
        ...
        self.df_log['Content_'] = self.df_log['Component'].map(preprocess)
    ...
    def log_to_dataframe(self, log_file, regex, headers, logformat):
        ...
        with open(log_file, 'r') as fin:
            for line in fin.readlines():
                if 0 == len(self.exceptRex) or None == re.search(self.exceptRex, line.strip()):
                    try:
