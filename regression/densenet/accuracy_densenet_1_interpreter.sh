...
$EVAL_FUNC \
    ...
    --mean_file=$REGRESSION_PATH/densenet/data/mean_resize.npy \
    --count=$1

$EVAL_FUNC \
    --model=densenet_quant_int8_per_layer.mlir \
    --dataset=$DATASET_PATH/imagenet/img_val_extracted \
    --mean_file=$REGRESSION_PATH/densenet/data/mean_resize.npy \
    --count=$1

$EVAL_FUNC \
    --model=densenet_quant_int8_per_channel.mlir \
    --dataset=$DATASET_PATH/imagenet/img_val_extracted \
    --mean_file=$REGRESSION_PATH/densenet/data/mean_resize.npy \
    --count=$1

$EVAL_FUNC \
    --model=densenet_quant_int8_multiplier.mlir \
    --dataset=$DATASET_PATH/imagenet/img_val_extracted \
    --mean_file=$REGRESSION_PATH/densenet/data/mean_resize.npy \
    --count=$1

$EVAL_FUNC \
    --model=densenet_quant_bf16.mlir \
    --dataset=$DATASET_PATH/imagenet/img_val_extracted \
    --mean_file=$REGRESSION_PATH/densenet/data/mean_resize.npy \
    --count=$1
