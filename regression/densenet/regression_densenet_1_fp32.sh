...
cvi_npz_tool.py compare densenet_out_fp32.npz densenet_out_fp32_fc6.npz -vvv
...
cvi_npz_tool.py compare densenet_opt_out_fp32.npz densenet_out_fp32_fc6.npz -v
