...
npz_compare.py mobilenet_v2_out_fp32.npz mobilenet_v2_out_fp32_prob.npz -v
npz_compare.py \
...
npz_compare.py mobilenet_v2_opt_out_fp32.npz mobilenet_v2_out_fp32_prob.npz -v
