...
export OUTPUTS=fc8
# export EXCEPTS=prob
export TOLERANCE_INT8_PER_TENSOR=0.98,0.98,0.83
...
# export EXCEPTS=prob
export TOLERANCE_INT8_PER_TENSOR=0.84,0.84,0.41
export TOLERANCE_INT8_RSHIFT_ONLY=0.93,0.93,0.63
...
export TOLERANCE_INT8_MULTIPLER=0.38,0.30,-0.55
...
export OUTPUTS=fc7
export EXCEPTS=prob
export TOLERANCE_INT8_PER_TENSOR=0.59,0.57,-0.01
export TOLERANCE_INT8_RSHIFT_ONLY=0.91,0.89,0.56
export TOLERANCE_INT8_MULTIPLER=0.90,0.89,0.56
