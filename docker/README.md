...
$ docker images
$ docker image rm cvitek/cvitek_dev:1.4-ubuntu-18.04
$ docker image prune
```
...
$ docker build -t cvitek/cvitek_dev:1.4-ubuntu-18.04 .

$ cp Dockerfile_ubuntu-16.04 Dockerfile
$ docker build -t cvitek/cvitek_dev:1.4-ubuntu-16.04 .
```
...
$ docker pull cvitek/cvitek_dev:1.4-ubuntu-16.04
```
...
$ docker run -itd \
    ...
    -v /data/models:/work/models \
    -v /data/dataset:/work/dataset \
    --name cvitek cvitek/cvitek_dev:1.4-ubuntu-16.04
...
$ docker run -itd [--cpus="1.5"] \
    -v $PWD:/work \
    -v /data/models:/work/models \
    --name cvitek_dev_18.04 cvitek/cvitek_dev:1.4-ubuntu-18.04
$ docker exec -it cvitek_dev_18.04 bash

$ docker run -itd [--cpus="1.5"] \
    -v $PWD:/work \
    -v /data/models:/work/models \
    --name cvitek_dev_16.04 cvitek/cvitek_dev:1.4-ubuntu-16.04
