...
function wider_eval(pred_dir,legend_name)
    ...
    wider_result(legend_name, setting_name_list,dir_int,seting_class,dateset_class);
    % wider_plot(legend_name, setting_name_list,dir_int,seting_class,dateset_class,plot_out_path);
