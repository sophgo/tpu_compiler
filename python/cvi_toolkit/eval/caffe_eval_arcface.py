...
parser = argparse.ArgumentParser(description="Arcface Evaluation on LFW Dataset.")
...
if __name__ == '__main__':
    ...
    while _line:
        ...
        out = net.forward()
        face_feature_1 = copy.copy(out['fc1']) #inplace
        #out = module.run(img2)
        #face_feature_2 = copy.copy(out['fc1_scale_dequant'])
        net.blobs['data'].data[...] = img2
        out = net.forward()
        face_feature_2 = copy.copy(out['fc1'])
    ...
    print('Model: {_m}'.format(_m=args.model_def))
