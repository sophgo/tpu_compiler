...
module {
  func @test_conv_2d(%arg0: tensor<1x3x28x28xf32>) -> tensor<1x16x28x28xf32> {
    ...
    %0 = "tpu.conv_2d"(%arg0, %cst, %cst_0) {dilation_h_factor = 1 : i32, dilation_w_factor = 1 : i32, fused_activation_function = "RELU", padding = "SAME", stride_h = 1 : i32, stride_w = 1 : i32, with_bias = true} : (tensor<1x3x28x28xf32>, tensor<16x3x3x3xf32>, tensor<16xf32>) -> tensor<1x16x28x28xf32>
