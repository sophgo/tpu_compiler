...
module {
  func @tpu_func(%arg0: tensor<109x87xf32>, %arg1: tensor<80x56xf32>) -> (tensor<1xf32>) {
    ...
    %3 = "tpu.none"() : () -> none
    %4 = "tpu.none"() : () -> none
    %5 = "tpu.match_template"(%1,%2,%3,%4) {name = "match", mode = "TM_CCOEFF_NORMED", quant = {mode = "NONE", param_type = "NONE", threshold = 0.000000e+00 : f32}} : (tensor<109x87xf32>, tensor<80x56xf32>, none, none) -> tensor<30x32xf32>
