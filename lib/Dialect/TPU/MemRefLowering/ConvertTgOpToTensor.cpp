...
struct ConvertTgOpToTensorPass : public mlir::PassWrapper<ConvertTgOpToTensorPass, FunctionPass> {
  void runOnFunction() override {
    ...
    patterns.insert<
        ...
        convertTgOpToTensorPattern<tpu::TG_MemRef_INT8_ReverseOp, tpu::TG_INT8_ReverseOp>,
        convertTgOpToTensorPattern<tpu::TG_MemRef_BF16_ReverseOp, tpu::TG_BF16_ReverseOp>,
        ...
        convertTgOpToTensorPattern<tpu::TG_MemRef_INT8_LstmOp, tpu::TG_INT8_LstmOp>,
