...
struct TpuQuantInt8DivOpPattern : public RewritePattern {
  TpuQuantInt8DivOpPattern(MLIRContext *context)
  ...
  PatternMatchResult matchAndRewrite(Operation *op,
    ...
    divOp.setOperand(1, y0_table_op);
    setOpQuantPerchannel(op, false);
    setOpQuant(op, "INT8");
...
struct TpuQuantInt8SqrtOpPattern : public RewritePattern {
  TpuQuantInt8SqrtOpPattern(MLIRContext *context)
  ...
  PatternMatchResult matchAndRewrite(Operation *op,
    ...
    auto y0_table_op = addWeightTensorAndCreateWeightOp<float>(
        op, "y0_table", y0_table, shape, storageType, wTF, wfV);
    sqrtOp.setOperand(1, y0_table_op);
    setOpQuantPerchannel(op, false);
    setOpQuant(op, "INT8");
