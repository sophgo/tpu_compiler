...
void cvi_backend_tl_lrn(
  ...
  uint32_t sum_size = ctx.lmem_tensor_to_size(lshape.n, lshape.c, lshape.h, lshape.w);
  ...
  uint32_t sum_high_size = ctx.lmem_tensor_to_size(lshape.n, lshape.c, lshape.h, lshape.w);
  ...
  uint32_t shift_sum_size = ctx.lmem_tensor_to_size(lshape.n, lshape.c, lshape.h, lshape.w);
  ...
  uint32_t top_high_size = ctx.lmem_tensor_to_size(lshape.n, lshape.c, lshape.h, lshape.w);
  ...
  uint32_t top_high_high_size = ctx.lmem_tensor_to_size(lshape.n, lshape.c, lshape.h, lshape.w);
