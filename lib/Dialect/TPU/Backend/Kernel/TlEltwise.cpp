...
void cvi_backend_tl_eltwise_op(
  ...
  if (prealloc) {
    ...
    tl_working_l = ctx.lmem_alloc_tensor(ctx.tl_shape_t4(1, inputTileShapeC, inputTileShapeH / stride_h, inputTileShapeW / stride_w), CVK_FMT_I8, /*eu_align=*/1);
    tl_working_h = ctx.lmem_alloc_tensor(ctx.tl_shape_t4(1, inputTileShapeC, inputTileShapeH / stride_h, inputTileShapeW / stride_w), CVK_FMT_I8, /*eu_align=*/1);
    tl_addend[0] = ctx.lmem_alloc_tensor(ctx.tl_shape_t4(1, inputTileShapeC, inputTileShapeH, inputTileShapeW), CVK_FMT_I8, /*eu_align=*/1);
    tl_addend[1] = ctx.lmem_alloc_tensor(ctx.tl_shape_t4(1, inputTileShapeC, inputTileShapeH, inputTileShapeW), CVK_FMT_I8, /*eu_align=*/1);
  ...
  cvk_tl_stride_t default_stride = ctx.tl_default_stride(ctx.tl_shape_t4(n, c, h, w), CVK_FMT_I8, 1);
  cvk_tl_stride_t output_default_stride = ctx.tl_default_stride(ctx.tl_shape_t4(n, c, oh, ow), CVK_FMT_I8, 1);
  ...
  for (uint32_t n_pos = 0; n_pos < (uint32_t)n; n_pos++) {
    for (uint32_t c_pos = 0; c_pos < (uint32_t)c; c_pos += inputTileShapeC) {
      ...
      for (uint32_t h_pos = 0; h_pos < reshapeInputHSize; h_pos += inputTileShapeH) {
        ...
        tl_addend_tmp.shape = ctx.tl_shape_t4(1, cur_c, cur_h, inputTileShapeW);
        ...
        tl_input_pos.shape = ctx.tl_shape_t4(1, cur_c, cur_h, inputTileShapeW);
        ...
        tl_working_h_tmp.shape = ctx.tl_shape_t4(1, cur_c, cur_h / stride_h, inputTileShapeW / stride_w);
        ...
        tl_working_l_tmp.shape = ctx.tl_shape_t4(1, cur_c, cur_h / stride_h, inputTileShapeW / stride_w);
        ...
        tl_input_pos_with_stride.shape = ctx.tl_shape_t4(1, cur_c, cur_h / stride_h, inputTileShapeW / stride_w);
        // stride
        ...
        tl_addend_tmp_with_stride.shape = ctx.tl_shape_t4(1, cur_c, cur_h / stride_h, inputTileShapeW / stride_w);
        ...
        tl_output_pos.shape = ctx.tl_shape_t4(1, cur_c, cur_h/stride_h, inputTileShapeW/stride_w);
