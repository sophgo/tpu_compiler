...
// output
  ...
  cvk_tl_shape_t tl_weight_shape = {
      static_cast<uint32_t>(1), static_cast<uint32_t>(output_c), static_cast<uint32_t>(kh),
...
void cvi_backend_tl_deconv(
  ...
  for (int ig = 0; ig < group; ig++) {
    ...
    cvk_tl_shape_t tl_input_shape = {
        static_cast<uint32_t>(input_n), static_cast<uint32_t>(ic), static_cast<uint32_t>(input_h),
        static_cast<uint32_t>(input_w)};
    ...
    cvk_tl_shape_t tl_output_shape = {
        static_cast<uint32_t>(input_n), static_cast<uint32_t>(oc), static_cast<uint32_t>(output_h),
        static_cast<uint32_t>(output_w)};
    ...
    auto weight_offset = ((oc * ig) / NPU_NUM) * ic * input_h * input_w +
                        ((oc * ig) % NPU_NUM) * LOCAL_MEM_SIZE;
    cvk_tl_shape_t tl_weight_shape = {
        static_cast<uint32_t>(ic), static_cast<uint32_t>(oc), static_cast<uint32_t>(kh),
        static_cast<uint32_t>(kw)};
