...
void lmem_shrink_fp32_bf16(const CviBackendContext &ctx,
    ...
    *lmem_bf16 = *lmem_fp32;
    lmem_bf16->shape = ctx.tl_shape_t4(bf16_n, bf16_c, bf16_h, bf16_w);
    ...
    lmem_fp32->shape = ctx.tl_shape_t4(bf16_n, bf16_c, bf16_h, bf16_w);
...
void fill_fp32_lmem_0(const CviBackendContext &ctx, uint32_t layer_id,
  ...
  // force clean all
  cvk_tl_shape_t input_shape = ctx.tl_shape_t4(n, c, h * 2, w * 2); // fp32 takes 4 times than int8
