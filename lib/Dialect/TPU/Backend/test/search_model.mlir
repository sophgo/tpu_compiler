...
module {
  func @tpu_func(%arg0: tensor<1x1x256x1xf32>, %arg1: tensor<1x4096x256x1xf32>) -> tensor<1x4096xf32> {
    ...
    %9 = "tpu.none"() : () -> none
    %10 = "tpu.broadcast_sub"(%8, %5, %9, %9, %9, %9) {name = "sub", quant = {is_asymmetric = false, is_perchannel = false, mode = "NONE", param_type = "NONE", threshold_max = 0.000000e+00 : f32, threshold_min = 0.000000e+00 : f32}} : (tensor<1x4096x256x1xf32>, tensor<1x1x256x1xf32>, none, none, none, none) -> tensor<1x4096x256x1xf32>
    %11 = "tpu.square"(%10) {name = "mul", quant = {is_asymmetric = false, is_perchannel = false, mode = "NONE", param_type = "NONE", threshold_max = 0.000000e+00 : f32, threshold_min = 0.000000e+00 : f32}} : (tensor<1x4096x256x1xf32>) -> tensor<1x4096x256x1xf32>
    ...
    %14 = "tpu.none"() : () -> none
    %15 ="tpu.fully_connected"(%12, %13, %14, %14, %14, %14, %14) {name = "out", quant = {is_asymmetric = false, is_perchannel = false, mode = "NONE", param_type = "NONE", threshold_max = 0.000000e+00 : f32, threshold_min = 0.000000e+00 : f32}} : (tensor<4096x256xf32>, tensor<1x256xf32>, none, none, none, none, none) -> tensor<4096x1xf32>
