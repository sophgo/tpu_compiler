module {
  func @tpu_func(%arg0: tensor<4x3x224x224xf32>) -> tensor<4x32x112x112xf32> {
    ...
    %1 = "tpu.input"(%arg0) {name = "data", quant = {mode = "NONE", param_type = "NONE", threshold = 0.000000e+00 : f32}} : (tensor<4x3x224x224xf32>) -> tensor<4x3x224x224xf32>
