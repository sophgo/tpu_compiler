module  {
  func @tpu_func(%arg0: tensor<4x1x256x512xf32>) -> (tensor<4x1x256x512xf32>, tensor<4x1x256x512xf32>, tensor<4x1x256x512xf32>) {
    ...
    %4 = "tpu.none"() : () -> none
    %5 = "tpu.conv_2d"(%1, %2, %3, %4, %4, %4, %4) {name = "X0_Neg", param = {dilation_h = 1 : i32, dilation_w = 1 : i32, do_relu = false, group = 1 : i32, ins = [], is_dw = true, pad_value = 0 : i32, padding = "VALID", padding_b = 0 : i32, padding_l = 0 : i32, padding_r = 0 : i32, padding_t = 0 : i32, stride_h = 1 : i32, stride_w = 1 : i32, with_bias = true}, quant = {mode = "NONE", param_type = "NONE", threshold_max = 0.000000e+00 : f32, threshold_min = 0.000000e+00 : f32}} : (tensor<4x1x256x512xf32>, tensor<1x1x1x1x1xf32>, tensor<1xf32>, none, none, none, none) -> tensor<4x1x256x512xf32>
    %6 = "tpu.none"() : () -> none
    %7 = "tpu.softmax"(%5, %6, %6, %6, %6) {axis = 1 : i32, name = "X1_Softmax", quant = {mode = "NONE", param_type = "NONE", threshold_max = 0.000000e+00 : f32, threshold_min = 0.000000e+00 : f32}} : (tensor<4x1x256x512xf32>, none, none, none, none) -> tensor<4x1x256x512xf32>
    %8 = "tpu.none"() : () -> none
    %9 = "tpu.softmax"(%5, %8, %8, %8, %8) {axis = 2 : i32, name = "X2_Softmax", quant = {mode = "NONE", param_type = "NONE", threshold_max = 0.000000e+00 : f32, threshold_min = 0.000000e+00 : f32}} : (tensor<4x1x256x512xf32>, none, none, none, none) -> tensor<4x1x256x512xf32>
    %10 = "tpu.none"() : () -> none
    %11 = "tpu.softmax"(%5, %10, %10, %10, %10) {axis = 3 : i32, name = "X3_Softmax", quant = {mode = "NONE", param_type = "NONE", threshold_max = 0.000000e+00 : f32, threshold_min = 0.000000e+00 : f32}} : (tensor<4x1x256x512xf32>, none, none, none, none) -> tensor<4x1x256x512xf32>
