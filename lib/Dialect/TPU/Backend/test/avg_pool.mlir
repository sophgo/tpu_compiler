...
module {
  func @tpu_func(%arg0: tensor<1x1024x17x17xf32>) -> tensor<1x1024x17x17xf32> {
    ...
    %1 = "tpu.input"(%arg0) {layer_id = 0 : i32, name = "data", quant = {is_asymmetric = false, is_perchannel = false, mode = "NONE", param_type = "NONE", threshold_max = 0.000000e+00 : f32, threshold_min = 0.000000e+00 : f32, zero_point = 0 : i32}} : (tensor<1x1024x17x17xf32>) -> tensor<1x1024x17x17xf32>
    %2 = "tpu.none"() : () -> none
