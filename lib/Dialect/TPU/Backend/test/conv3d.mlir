...
module {
  func @tpu_func(%arg0: tensor<1x2x4x3x3xf32>) -> tensor<1x4x3x2x2xf32> {
    ...
    %1 = "tpu.input"(%arg0) {name = "input", quant = {mode = "NONE", param_type = "NONE", threshold_max = 0.000000e+00 : f32, threshold_min = 0.000000e+00 : f32}} : (tensor<1x2x4x3x3xf32>) -> tensor<1x2x4x3x3xf32>
