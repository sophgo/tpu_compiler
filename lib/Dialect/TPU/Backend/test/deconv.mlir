module {
  func @tpu_func(%arg0: tensor<1x16x64x128xf32>) -> tensor<1x1x128x256xf32> {
    ...
    %1 = "tpu.input"(%arg0) {name = "data0", quant = {mode = "NONE", param_type = "NONE", threshold = 0.000000e+00 : f32}} : (tensor<1x16x64x128xf32>) -> tensor<1x16x64x128xf32>
