module {
  func @tpu_func(%arg0: tensor<1x3x1x22400xf32>) -> tensor<1x1x1x5600xf32> {
    ...
    %1 = "tpu.input"(%arg0) {name = "data", quant = {mode = "NONE", param_type = "NONE", threshold = 0.000000e+00 : f32}} : (tensor<1x3x1x22400xf32>) -> tensor<1x3x1x22400xf32>
