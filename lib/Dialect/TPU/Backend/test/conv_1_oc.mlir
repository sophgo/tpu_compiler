module {
  func @tpu_func(%arg0: tensor<1x64x288x512xf32>) -> tensor<1x1x288x512xf32> {
    ...
    %1 = "tpu.input"(%arg0) {name = "data", quant = {mode = "NONE", param_type = "NONE", threshold_max = 0.000000e+00 : f32, threshold_min = 0.000000e+00 : f32}} : (tensor<1x64x288x512xf32>) -> tensor<1x64x288x512xf32>
