...
module {
  func @tpu_func(%arg0: tensor<8x32x32x60xf32>) -> tensor<8x32x32x60xf32> {
    ...
    %5 = "tpu.layer_norm"(%1, %3, %4, %2, %2) {name = "layer_norm", normalized_shape = [32:i32,60:i32], eps = 1.0e-5:f32, quant = {is_asymmetric = false, is_perchannel = false, mode = "NONE", param_type = "NONE", threshold_max = 0.000000e+00 : f32, threshold_min = 0.000000e+00 : f32, zero_point = 0 : i32}} : (tensor<8x32x32x60xf32>, tensor<32x60xf32>, tensor<32x60xf32>, none, none) -> tensor<8x32x32x60xf32>
