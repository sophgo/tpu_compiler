...
class MixNet {
 ...
 private:
  ...
  void _add_tl_scale_op(MixOp *mix_op, const std::vector<int> &in_tensors,
                        const std::vector<int> &out_tensors,
                        net_timestep *time_step, int timestep_idx,
                        bool is_h_split);

  void _add_tl_scale_lut_op(MixOp *mix_op, const std::vector<int> &in_tensors,
                            const std::vector<int> &out_tensors,
                            net_timestep *time_step, int timestep_idx,
                            bool is_h_split);

  void _add_tl_upsample_op(MixOp *mix_op, const std::vector<int> &in_tensors,
                           const std::vector<int> &out_tensors,
                           net_timestep *time_step, int timestep_idx,
                           bool is_h_split);
