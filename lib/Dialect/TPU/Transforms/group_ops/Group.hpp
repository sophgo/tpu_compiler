...
class Group {
 public:
  explicit Group(NetGraph *net_graph) : time_step(nullptr), net_graph_(net_graph), layers_() {}
 ...
 private:
  ...
  bool backward_slice(int out_tensor_id, list<int> &branches, bool max_h_slice, bool no_split_h);
