...
DECLARE_ALL_COMMON_INTERFACE_METHODS(EltwiseConstOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_INT8_EltwiseConstOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_BF16_EltwiseConstOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_StrideCopyOp)
...
DECLARE_ALL_QUANT_INTERFACE_METHODS(EltwiseConstOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_INT8_EltwiseConstOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_BF16_EltwiseConstOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_StrideCopyOp)
