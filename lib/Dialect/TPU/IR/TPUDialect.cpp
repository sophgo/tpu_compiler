...
DECLARE_ALL_COMMON_INTERFACE_METHODS(PreprocessOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TransposeOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_ConcatOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_ConcatOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_PT_Conv2DOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_PC_Conv2DOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_Conv2DOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_ClipOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_ClipOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_CropOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_CropOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_PT_DeConv2DOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_PC_DeConv2DOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_DeConv2DOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_EltwiseAddOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_EltwiseMaxOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_EltwiseMulOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_EltwiseAddOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_EltwiseMaxOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_EltwiseMulOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_FullyConnectedOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_FullyConnectedOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_LeakyReluOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_LeakyReluOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_LutOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_LutOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_LrnOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_LrnOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_PermuteOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_PermuteOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_PoolAvg2DOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_PoolMax2DOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_ShuffleChannelOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_ShuffleChannelOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_PixelShuffleOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_PixelShuffleOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_PReluOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_PReluOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_ReluOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_ReluOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_SliceOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_SliceOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_SwapChannelOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_SwapChannelOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_UpsampleOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_UpsampleOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_MemRef_EltwiseMulOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_Conv2DOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_EltwiseAddOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_LrnOp)
...
DECLARE_ALL_QUANT_INTERFACE_METHODS(GenericCpuOp)
DECLARE_ALL_QUANT_INTERFACE_METHODS(PowerOp)
DECLARE_ALL_QUANT_INTERFACE_METHODS(PReluOp)
DECLARE_ALL_QUANT_INTERFACE_METHODS(PreprocessOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(QuantOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_ConcatOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_ConcatOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_PT_Conv2DOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_PC_Conv2DOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_Conv2DOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_ClipOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_ClipOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_CropOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_CropOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_PT_DeConv2DOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_PC_DeConv2DOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_DeConv2DOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_EltwiseAddOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_EltwiseMaxOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_EltwiseMulOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_EltwiseAddOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_EltwiseMaxOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_EltwiseMulOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_FullyConnectedOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_FullyConnectedOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_LeakyReluOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_LeakyReluOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_LutOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_LutOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_LrnOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_LrnOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_PermuteOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_PermuteOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_PoolAvg2DOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_PoolMax2DOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_ShuffleChannelOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_ShuffleChannelOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_PixelShuffleOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_PixelShuffleOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_PReluOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_PReluOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_ReluOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_ReluOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_SliceOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_SliceOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_SwapChannelOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_SwapChannelOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_UpsampleOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_UpsampleOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TL_MemRef_EltwiseMulOp)
...
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_Conv2DOp)
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_EltwiseAddOp)
...
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_LrnOp)
