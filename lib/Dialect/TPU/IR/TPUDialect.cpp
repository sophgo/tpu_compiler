...
DECLARE_ALL_COMMON_INTERFACE_METHODS(SquareSumOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_BF16_SquareSumOp)
...
DECLARE_ALL_QUANT_INTERFACE_METHODS(SquareSumOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_BF16_SquareSumOp)
