...
DECLARE_ALL_COMMON_INTERFACE_METHODS(LstmCaffeOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(Yuv420CscOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_BF16_Yuv420CscOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_ReverseOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_ReverseOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_ReQuantOp)
...
DECLARE_ALL_QUANT_INTERFACE_METHODS(Yuv420CscOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_BF16_Yuv420CscOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_ReverseOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_ReverseOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_ReQuantOp)
