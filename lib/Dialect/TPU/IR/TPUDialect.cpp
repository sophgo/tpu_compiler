...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_DeConv2DOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_EltwiseAddOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_EltwiseMulOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_BroadcastMulOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_UpsampleOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_LeakyReluOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_LutOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_PReluOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_ConcatOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_PadOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_CropOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_ReluOp)
...
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_DeConv2DOp)
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_EltwiseAddOp)
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_EltwiseMulOp)
...
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_BroadcastMulOp)
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_UpsampleOp)
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_LeakyReluOp)
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_LutOp)
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_PReluOp)
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_ConcatOp)
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_PadOp)
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_CropOp)
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_ReluOp)
