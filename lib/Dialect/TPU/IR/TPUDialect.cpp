...
DECLARE_ALL_COMMON_INTERFACE_METHODS(CastOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TileInterpOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_BF16_INT8_CastOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_FP32_INT8_CastOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_INT8_BF16_CastOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_FP32_BF16_CastOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_INT8_FP32_CastOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_BF16_FP32_CastOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_INT8_TileInterpOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_BF16_TileInterpOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_CastOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_EltwiseMinOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_EltwiseMinOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_GenericTpuOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_GenericTpuOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_QuantOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_QuantOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_ReluOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_ReluOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_ReorgOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_ReorgOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_PadOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_PadOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_ReduceMeanOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_ReduceMeanOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_ReduceMaxOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_ReduceMaxOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_GruOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_GruOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_LstmOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_LstmOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_SoftmaxOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_SoftmaxOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_INT8_ZeroMaskOp)
DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_BF16_ZeroMaskOp)

DECLARE_ALL_COMMON_INTERFACE_METHODS(TG_MemRef_CastOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_BroadcastMulOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_INT8_BroadcastMulOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_INT8_QuantOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_INT8_ZeroMaskOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_BF16_BroadcastMulOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_BF16_QuantOp)
...
DECLARE_ALL_COMMON_INTERFACE_METHODS(TL_LG_BF16_ZeroMaskOp)
...
DECLARE_ALL_QUANT_INTERFACE_METHODS(TileInterpOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_BF16_INT8_CastOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_FP32_INT8_CastOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_FP32_BF16_CastOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_INT8_BF16_CastOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_BF16_FP32_CastOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_INT8_FP32_CastOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_INT8_TileInterpOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_BF16_TileInterpOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_CastOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_EltwiseMinOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_EltwiseMinOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_GenericTpuOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_GenericTpuOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_QuantOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_QuantOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_ReluOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_ReluOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_ReorgOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_ReorgOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_PadOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_PadOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_ReduceMeanOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_ReduceMeanOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_ReduceMaxOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_ReduceMaxOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_GruOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_GruOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_LstmOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_LstmOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_SoftmaxOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_SoftmaxOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_INT8_ZeroMaskOp)
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_BF16_ZeroMaskOp)

DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TG_MemRef_CastOp)
...
DECLARE_ALL_CODEGEN_INTERFACE_METHODS(TL_BroadcastMulOp)
...
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_INT8_BroadcastMulOp)
...
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_INT8_QuantOp)
...
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_INT8_ZeroMaskOp)
...
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_BF16_BroadcastMulOp)
...
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_BF16_QuantOp)
...
DECLARE_TL_CODEGEN_INTERFACE_METHODS(TL_LG_BF16_ZeroMaskOp)
