...
DECLARE_GET_OP_NAME_METHOD_LEGACY(ShuffleChannelOp)
...
DECLARE_GET_LAYER_ID_METHOD(ShuffleChannelOp)
...
DECLARE_GET_RESULT_QUANT_THRESHOLD_METHOD(ShuffleChannelOp)
...
DECLARE_SET_RESULT_QUANT_THRESHOLD_METHOD(ShuffleChannelOp)
...
DECLARE_GET_OP_QUANT_METHOD(ShuffleChannelOp)
...
DECLARE_GET_RESULT_ADDRESS_METHOD(ShuffleChannelOp)
...
DECLARE_SET_RESULT_ADDRESS_METHOD(ShuffleChannelOp)
